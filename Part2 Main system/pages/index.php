<?php
    ...
    case "Employee":
        $pages = ["dashboard", "tasks", "todo", "tutorials", "forums", "chat"];
        break;
    case "Manager":
        $pages = ["dashboard", "projects", "todo", "tutorials", "forums", "chat"];
        break;
    case "Admin":
        $pages = ["dashboard", "projects", "todo", "tutorials", "forums", "users", "chat"];
        break;
    default:
