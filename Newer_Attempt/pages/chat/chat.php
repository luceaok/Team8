<?php 
$nodeServerRunning = exec("pgrep -f 'node user.js'");

if(empty($nodeServerRunning)){
    exec("node user.js > /dev/null 2>&1 &");
}
...
<script>
    // const socket = io("http://localhost/Team-project-main/pages/?page=chat");
    const socket = io();
